...
ncld_detailed_percentage <- read_csv("../data/processed/nlcd_2001_detailed_percentages.csv")
nlcd_detailed_percentage <- read_csv("./data/processed/nlcd_2001_detailed_percentages.csv")
