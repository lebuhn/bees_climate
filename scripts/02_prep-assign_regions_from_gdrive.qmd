...
```{r}
# this is a plain csv
write_csv(regional.data, '../data/processed/eco.data.csv')
# this preserves the spatial data for mapping
st_write(regional.data, "../data/processed/eco.data.gpkg", append = FALSE) # false overwrites instead of appends
```